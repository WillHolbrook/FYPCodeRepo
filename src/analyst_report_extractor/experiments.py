...
@log_time
def calculate_idf_for_corpus_parallel(root_folder_path: Path, max_num_processes: int = 8) -> tuple[
...
def main():
    ...
    idf_p, term_count_p, num_docs_p = calculate_idf_for_corpus_parallel(root_folder_path, max_num_processes=8)
