...
ALLOWED_HOSTS = ['0.0.0.0', 'localhost', '127.0.0.1', 'willholbrook.com', 'www.willholbrook.com', '86.26.160.245']
...
CSRF_TRUSTED_ORIGINS = ['https://*.127.0.0.1', 'http://localhost:8020', 'http://localhost:3000']
